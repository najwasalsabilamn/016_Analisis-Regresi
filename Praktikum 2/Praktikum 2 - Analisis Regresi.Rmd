...
data <- read_excel("C:\\Users\\najwe\\OneDrive\\Dokumen\\SEMESTER 3\\SEMESTER 4\\ANREG\\NSC-2025.xlsx", sheet="Sheet2")
...
$$\hat{Y} = 84.25520 -0.9377205 X_1$$

dengan Y adalah Indeks Pembangunan Manusia dan X3 adalah Persentase Penduduk Miskin.

Didapatkan nilai $\hat\beta_0 = 84.25520$ artinya nilai dugaan rataan indeks pembangunan manusia ketika persentase penduduk miskin bernilai 0 persen adalah 84.255%, akan tetapi nilai 0 tidak ada dalam selang pengamatan persentase penduduk miskin sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_0 = -0.937$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika Rata-rata lama sekolah berubah satu tahun adalah sebesar -0.937%

Koefisien determinasi yang dihasilkan adalah 0.478 atau 47.8% artinya keragaman Indeks Pembangunan Manusia yang dapat dijelaskan oleh persentase penduduk miskin adalah sebesar 47.8%, sisanya yaitu 52.2% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
