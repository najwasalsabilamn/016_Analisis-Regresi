...
Saat ini terdapat 1 peubah Y dan 6 peubah X, misal ingin dilakukan eksplorasi dan analisis terkait peubah X1

```{r}
plot(data$X1, data$Y,
     main = "Prevalensi Balita Pneumonia vs Persentase Anak dengan Imunisasi Dasar Lengkap",
     xlab = "Prevalensi Balita Pneumonia",
     ylab = "Persentase Anak dengan Imunisasi Dasar Lengkap")
```
...
Nilai p kurang dari alpha 0.05 untuk b0 sehingga signifikan pada taraf nyata 5% sedangkan untuk b1 lebih dari 0.05 sehingga tidak signifikan
...
Nilai p lebih dari alpha 0.05 sehingga secara simultan X dan Y tidak saling memengaruhi
...
$$\hat{Y} = 2.00897 - 0.01436 X_1$$

dengan Y adalah Prevalensi Balita Pneumonia dan X1 adalah Persentase Anak Umur 12-23 Bulan yang Menerima Imunisasi Dasar Lengkap.

Didapatkan nilai $\hat\beta_0 = 2.00897$ artinya nilai dugaan rataan Prevalensi Balita Pneumonia ketika Persentase Anak Umur 12-23 Bulan yang Menerima Imunisasi Dasar Lengkap bernilai 0 tahun adalah 2.00897%, akan tetapi nilai 0 tidak ada dalam selang pengamatan rata-rata lama sekolah sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_1 = - 0.01436$ artinya nilai dugaan perubahan dugaan rataan Prevalensi Balita Pneumonia jika Persentase Anak Umur 12-23 Bulan yang Menerima Imunisasi Dasar Lengkap berubah satu tahun adalah sebesar -0.01436%

Koefisien determinasi yang dihasilkan adalah 0.04721 atau 47.21% artinya keragaman Prevalensi Balita Pneumonia yang dapat dijelaskan oleh Persentase Anak Umur 12-23 Bulan yang Menerima Imunisasi Dasar Lengkap adalah sebesar 47.21%, sisanya yaitu 52.79% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.